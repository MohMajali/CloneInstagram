...
import com.example.cloninstagram.SettingsActivity;
...
public class Profileragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        user = SharedprefManager.getInstance(getContext()).getUserData();
        user_id = user.getId();
    ...
    private void getAllImages(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL.get_all_images+user_id,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(!jsonObject.getBoolean("error")){
                                ...
                                if(!image.isEmpty()){
                                    Picasso.with(getContext()).load(image).error(R.drawable.user).into(user_profile_image);
                                }
