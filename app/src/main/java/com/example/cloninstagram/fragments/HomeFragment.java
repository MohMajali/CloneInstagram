...
import com.example.cloninstagram.Adapter.StoryListAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private void getFollowingIds(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL.get_following_ids+user_id,
    ...
    private void getLatestNewsFeed(String ids){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL.lasted_news_feed+ids,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            if(!jsonObject.getBoolean("error")){
                                ...
                                for(int i = 0 ; i<jsonObjectStories.length(); i++){
                                    ...
                                    Story story = new Story(jsonObjectSingleStory.getInt("id"),jsonObjectSingleStory.getInt("user_id")
                                            ...
                                            ,jsonObjectSingleStory.getString("title"),jsonObjectSingleStory.getString("story_time")
