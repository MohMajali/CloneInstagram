...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!imageProfile.isEmpty()){
            Picasso.with(getApplicationContext()).load(imageProfile).error(R.drawable.user).into(profile_image);
        }
    ...
    private void updateUserData(){
        ...
        final StringRequest stringRequest = new StringRequest(Request.Method.POST, URL.update_user_data,  new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if(!jsonObject.getBoolean("error")){
                        ...
                        if(!emailString.isEmpty()) {
                            ...
                            SharedprefManager.getInstance(getApplicationContext()).updateEmail(emailString);
                        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == CHANGE_PROFILE_IMAGE && resultCode == RESULT_OK && data != null){
    ...
    private void sendImageToDataBase(Bitmap bitmap){
        ...
        if(imageString!= null){
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL.update_profile_image,  new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if(!jsonObject.getBoolean("error")){
                            ...
                            if(!imageString.isEmpty()) {
                                Picasso.with(getApplicationContext()).load(imageString).error(R.drawable.user).into(profile_image);
                                //update profile image
                                SharedprefManager.getInstance(getApplicationContext()).updateProfileImage(imageString);
