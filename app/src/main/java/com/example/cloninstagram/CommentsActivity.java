...
import com.example.cloninstagram.Adapter.CommentListAdapter;
...
public class CommentsActivity extends AppCompatActivity {
    ...
    private  void getAllComments(int story_id){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL.get_all_comments+story_id,
    ...
    private void sendCommentToDB(final int story_id){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL.send_comment,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
