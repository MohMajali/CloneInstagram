...
import com.example.cloninstagram.Adapter.ImageArrayAdapter;
...
import com.example.cloninstagram.models.Image;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User user = SharedprefManager.getInstance(getApplicationContext()).getUserData();
        user_id = user.getId();
    ...
    private void getAllImages(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL.get_all_images+other_user_id,
    ...
    private void getOtherUsersProfileData(User user){
        ...
        if(!user.getImage().isEmpty()){
            ...
            Picasso.with(getApplicationContext()).load(user.getImage()).error(R.drawable.user).into(other_user_profile_image);
        }
    ...
    private void IsCurrentUserFollowingThisUser(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL.check_following_state+other_user_id+"&user_id="+user_id,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    private void unfollowThisUser(){
        ...
        follow_this_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, URL.unfollow_this_person+other_user_id+"&user_id="+user_id,
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
    ...
    private void followThisUser(){
        ...
        follow_this_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, URL.follow_this_person+other_user_id+"&user_id="+user_id,
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
